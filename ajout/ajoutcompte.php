...
//* {
	...
	*/
	if(mb_strtoupper($ret_per["fonction"])==$suit)
	{
		...
		{
				echo'<script type="text/javascript">alert(" Aia ianaoreo izao !")</script>';
	...
	{
		echo('<script type="text/javascript">alert(" ///// Vous navez pas l autorisation de faire cette action ! ///// ")</script>');
