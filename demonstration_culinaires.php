...
<div class="navbar navbar-expand-sm bg-dark navbar-nav"><?php require("complement/entete2.php") ?></div>
	<div class="container spacer col-md-5 col-xs-12 col-md-offset-3">
				<div class="panel panel-info">
					<div class="panel-heading"><h3>ACTIVITE PNCC :<em>Démonstration culinaires</em></h3> </div>
						<div class="panel-body">
							<form method="POST" action="../ajout/p_dem_cul.php">
								<div class="body-panel-body" id="primo">
									...
									<div class="form-group">
										...
										<input type="text" name="d1" id="a4" placeholder="récensés" class="form-control" size="22" />
									</div>
									<div  class="btn-block">
