...
CREATE TABLE `commune` (
  ...
  `code_district` int(11) NOT NULL,
  `photocommune` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `fonction` (
  `fonct` varchar(250) NOT NULL,
  `ab_fonct` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `fonction` (`fonct`, `ab_fonct`) VALUES
('Coordonateur Regionale', 'CR'),
('Responsable Administatratif et Financiere', 'RAF'),
('Responsable Suivi et Evaluation', 'RSE'),
('Secrétaire Comptable', 'Sec Compt');
...
CREATE TABLE `province` (
  ...
  `photoprovince` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `province` (`id_province`, `nom_province`, `photoprovince`) VALUES
(1, 'ANTANANARIVO', 'ANTANANARIVO.JPG'),
(2, 'FIANARANTSOA', 'FIANARANTSOA.JPG'),
(3, 'TOAMASINA', 'TOAMASINA.PNG'),
(4, 'MAHAJANGA', 'MAHAJANGA.JPG');
...
CREATE TABLE `region` (
  ...
  `photoregion` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `region` (`id_region`, `nom_region`, `code_province`, `photoregion`) VALUES
(25, 'MATSIATRA AMBANY', 2, 'MATSIATRA AMBANY.PNG'),
(29, 'IHOROMBE', 2, 'IHOROMBE.JPG');
...
ALTER TABLE `commune`
  ...
  ADD KEY `code_district` (`code_district`);
...
--
ALTER TABLE `commune`
  ADD CONSTRAINT `commune_ibfk_1` FOREIGN KEY (`code_district`) REFERENCES `district` (`id_district`);
...
--
ALTER TABLE `district`
  ADD CONSTRAINT `district_ibfk_1` FOREIGN KEY (`code_region`) REFERENCES `region` (`id_region`);
...
--
ALTER TABLE `region`
  ADD CONSTRAINT `region_ibfk_1` FOREIGN KEY (`code_province`) REFERENCES `province` (`id_province`);

--
-- Contraintes pour la table `site`
--
ALTER TABLE `site`
  ADD CONSTRAINT `site_ibfk_1` FOREIGN KEY (`codecommune`) REFERENCES `commune` (`id_commune`) ON DELETE CASCADE ON UPDATE CASCADE;
